  ...
  <div class="qq-wrapper">
    ...
    <div class="Login">
      <div class="head">
        ...
        <div class="h-right">
          <div @click="router.push('/logvx')">微信登录</div>
          <div
            style="color: #3091DB; text-decoration: underline"
          >
            QQ登录
          </div>
        </div>
      ...
      <div class="l-ways">
        <div class="qq">
            <div class="vx-icon" @click="router.push('/logvx')"></div>
          <div class="l-text">微信登录</div>
        </div>
        <div class="vx" @click="router.push('/log')">
          <!-- <div class="vx-icon"></div> -->
          <div class="l-text">返回登录</div>
        </div>
      </div>
    </div>
  </div>
